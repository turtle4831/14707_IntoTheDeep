...
public class ChoreoTrajectory {
    ...
    private ChoreoTrajectoryState sampleInternal(double timestamp) {
        ...
        ChoreoTrajectoryState behindState = samples.get(low - 1);
        ChoreoTrajectoryState aheadState = samples.get(low);
    ...
    public ChoreoTrajectory flipped() {
        ArrayList<ChoreoTrajectoryState> flippedStates = new ArrayList<>();
        for (ChoreoTrajectoryState state : samples) {
